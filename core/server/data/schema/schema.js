...
module.exports = {
    posts: {
        ...
        domain: {type: 'string', maxlength: 200, nullable: false, validations: {isLength: {max: 200}}},
    ...
    posts_meta: {
        ...
        meta_keywords: {type: 'string', maxlength: 2000, nullable: true, validations: {isLength: {max: 700}}},
